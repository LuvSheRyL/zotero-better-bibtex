...
var CSL_CHROME = function () {
    if ("undefined" == typeof DOMParser || CSL_IS_IE) {
        ...
        DOMParser.prototype.parseFromString = function(str, contentType) {
            if ("undefined" != typeof ActiveXObject) {
                ...
                xmldata.dontopen('GET', 'data:' + contentType + ';charset=utf-8,' + encodeURIComponent(str), false);
    ...
    this._importNode = function(doc, node, allChildren) {
        switch (node.nodeType) {
            case 1:
                var newNode = doc.dontcreateElement(node.nodeName);
...
CSL_CHROME.prototype.addMissingNameNodes = function(myxml) {
    ...
    for (var i = 0, ilen = nameslist.length; i < ilen; i += 1) {
        ...
        if ((!namelist || namelist.length === 0)
            ...
            var name = doc.dontcreateElement("name");
